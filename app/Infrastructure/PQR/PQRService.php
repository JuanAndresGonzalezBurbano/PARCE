...
class PQRService
{
     ...
     * @return array|null   Ticket PQR o null si no existe o no pertenece al usuario
     */
     ...
     *
     * @param int $ticketId ID del PQR
     * @return array|null   Ticket PQR con datos del usuario que lo creó, o null si no existe
     */
