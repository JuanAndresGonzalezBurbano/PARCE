...
| ADR-5 | Rol de mecánico autodeclarado en el registro, sin flujo de aprobación vía `admin_access_requests` | Vigente, pero **marcado como decisión de producto pendiente de reconsiderar** (ver roadmap A.1) | `AuthService::register()`; tabla `admin_access_requests` sin uso en código |
